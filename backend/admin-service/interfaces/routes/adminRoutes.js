...
module.exports = (ctrl, auth, adminAuth) => {
  ...
  router.post("/feedbacks/:feedbackId/reply", auth, adminAuth, ctrl.replyFeedback);
  ...
  router.get("/dashboard/diagnosis-trend", auth, adminAuth, ctrl.getDiagnosisTrend);
  router.get("/dashboard/disease-distribution", auth, adminAuth, ctrl.getDiseaseDistribution);
  router.get("/dashboard/user-trend", auth, adminAuth, ctrl.getUserTrend);

  // ── AI 모니터링 ────────────────────────────
  router.get("/monitoring/performance", auth, adminAuth, ctrl.getPerformanceMetrics);
  router.get("/monitoring/disease-accuracy", auth, adminAuth, ctrl.getDiseaseAccuracy);
  router.get("/monitoring/system-status", auth, adminAuth, ctrl.getSystemStatus);
