...
app.use("/api/v1/notices", createNoticeRoutes(contentController, authenticate, requireAdmin));
app.use("/api/v1/encyclopedia", createEncyclopediaRoutes(contentController, authenticate, requireAdmin));
