...
import { Disease, ApiResponse, PaginatedResponse } from '@/src/types';
  ...
  try {
    ...
    return NextResponse.json({
      ...
      pagination: {
        ...
        total_pages: Math.ceil(diseases.length / limit)
      }
    } as unknown as ApiResponse<PaginatedResponse<Disease>>);
