  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="relative">
        ...
        <div className="relative flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-blue-500/30">
          <ScanFace className="h-10 w-10 text-white" strokeWidth={1.7} />
        </div>
      </div>
